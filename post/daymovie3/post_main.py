"""
This is another main program for making the daymovies and pushing them to homer.
It is just like daymovie1 but with a different list of movies, aimed at nested runs
like oly1.
...
if Ldir['testing'] == True:
    moviename_list = ['P1_Psouth_temp_top']
else:
    moviename_list = ['P1_Psouth_temp_top', 'P1_Psouth_salt_top']
