...
python post_main.py -gtx cas6_v0_u0mb -ro 0 -d [today's date string] -job surface0 > surface0.log &
...
# Send the file to Azure, to be picked up by Patrick Tripp for the IOOS S3-THREDDS server
if not Ldir['testing']:
