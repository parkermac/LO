...
Ldir = Lfun.Lstart()
in_fn = (Ldir['roms_out'] /
    'wgh2_t0_xn0b' / 'f2023.09.14' / 'ocean_his_0002.nc')
out_fn = (Ldir['parent'] / 'LO_output' / 'post' /
    'wgh2_t0_xn0b' / 'f2023.09.14' / 'layers2' / 'tempfiles' / 'layers_000000.nc')
...
do_carbon = True
# this flag is introduced to handle different testing choices
