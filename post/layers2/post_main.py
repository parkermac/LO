...
Testing on mac:
run post_main.py -gtx wgh2_t0_xn0b -ro 0 -d 2023.09.14 -r backfill -job layers2 -test True

Run for real on apogee:
python post_main.py -gtx wgh2_t0_xn0b -ro 0 -d [today's date string] -r forecast -job layers2
