...
This is just like atm01 except that we enforce limits on max and min Tair and Qair.
Motivated by a blowup of the long hindcast cas7_t1_x11ab for 2021.02.11.
...
if planB == False:
    ...
    for vn in outvar_list:
        ...
        # Enforce limits on Tair and Qair 2026.01.10
        if vn == 'Qair':
            qmat = D[vn].copy()
            qmat[qmat<0] = 0
            qmat[qmat>100] = 100
