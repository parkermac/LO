This code prepares the atmospheric forcing fields for a LiveOcean run using, if available, 3 resolutions of WRF output.  It makes use of very fast nearest neighbor interpolation to speed things up by a factor of about 12x (20 sec vs. 4 min for a cas6 backfill day).  And it produces much higher resolution forcing in the Salish Sea.
