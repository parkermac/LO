...
2026.03.18 This is just like driver_post1.py except:
(i) it is designed to be run on klone using driver_post11.sh
(ii) it runs all jobs at the same time
...
if Ldir['testing'] == True:
    job_list = ['daymovie0', 'drifters2']
else:
    job_list = ['ubc1', 'layers1', 'nest_wgh', 'daymovie0', 'surface1', 'sequim1',
        'nest_oly', 'drifters2','lowpass0']
...
for job in job_list:
    ...
    proc_list.append((proc,out_dir))

for proc, out_dir in proc_list:
