...
parser.add_argument('-tpn', '--tasks_per_node', type=int, help="total number of cores to use")
...
f  = open(pth / 'klone5a_batch_BLANK.sh','r')
f2 = open(Path(in_dict['roms_out_dir']) / 'klone_batch.sh','w')
