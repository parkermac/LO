...
NEW 2025.06.30
- this new version is based on driver_roms4.py, but will use the cpu-g2 nodes in a better way.
- it uses batch scripts klone5[]
...
testing on mac:
python5 driver_roms4.py -g cas7 -t t1 -x x4a -0 2017.01.01 -np 160 -N 32 -v True --get_forcing False --run_roms False --move_his False
