...
2025.09.27: This is just like driver_roms00 except that it does not try
again after blowing up. It also pushes the ROMS output to apogee even if there
was a blowup, and does not save a separate blowup folder on klone. The
purpose is to expedite investigation of blowups.
...
Testing on mac
run driver_roms00noRerun -g cas7 -t t1 -x x11b -r backfill -0 2025.07.04 -s continuation -np 192 -cpu cpu-g2 -grp macc -vip True -v True --get_forcing False --run_roms False --move_his False
